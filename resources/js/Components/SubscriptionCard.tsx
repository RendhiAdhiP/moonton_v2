...
type PropTypes = {
    ...
    features: string[]
    isPremium: boolean
    onSelectSubcription: () => void
}
const SubscriptionCard: React.FC<PropTypes> = ({ id, name, price, durationInMonth, features, isPremium, onSelectSubcription }) => {
    return (
        <>
            {/* Basic */}
            {!isPremium && (
            ...
            {isPremium && (
                <div
                    ...
                    <div>
                        <Button type="button" variant="primary" onClick={onSelectSubcription}>
